...
race_sleep_data <- race_sleep_data %>% left_join(device, by = "dev_id") %>% select("cust_id", "sex", "emoji_modifier", "date", "duration", "flags", "dev_id", "device_name")

device_data <- device_data %>% janitor::clean_names() 

race_sleep_data <- race_sleep_data %>% left_join(device_data, by = "device_name") %>% select("cust_id", "sex", "emoji_modifier", "date", "duration", "flags", "device_name", "line", "battery_life", "water_resitance", "heart_rate_sensor", "pulse_oximiter", "gps", "sleep_tracking", "smart_notifications")
