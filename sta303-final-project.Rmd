---
title: "Customer Demographics and Product Performance Analysis of MINGAR Products"
...
-     There are two or more levels on the independent variable, product line. 
-     The dependent variable, age, is on a ratio scale and 
-     The observations are independent.
-     All groups should have same shape distributions. In our case, three of the groups have same shape distribution, while Active line have a bimodal distribution, which may be caused by the lack of data. It is a limitation in the model assumption checking process.
