...
device_cust %>% ggplot(aes(x = sex, fill=line_binary)) + geom_bar() +  facet_wrap("line_binary") + theme_minimal() + scale_fill_manual(values = wes_palette("Moonrise3"))
```
...
group_income %>% ggplot(aes(x= hhld_median_inc, fill = line_binary)) + geom_histogram(bins = 30) + facet_wrap("line_binary") + theme_minimal() + scale_fill_manual(values = wes_palette("Moonrise3"))
