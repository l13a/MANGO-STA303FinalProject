...
-   How does skin color (identified by one's emoji modifiers) affect the number of quality flags that MINGAR wearable devices report during a sleep tracking session?
...
Figure A shows that there are more light emoji modifier users than dark emoji modifier users and there are more females than males and intersex users. Most users use the Advance or Run lines.
