...
We used APIs to get the data from the Canadian census website. First, we signed up for the cancensus API through the website and get the API key for our account.
