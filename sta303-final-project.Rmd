...
device_cust %>% ggplot(aes(x = age, fill=line)) + geom_histogram(bins = 30) +  facet_wrap("line") + theme_linedraw() + scale_fill_manual(values = wes_palette("GrandBudapest2"))
```
...
device_data %>% 
  ggplot(aes(x = Released, y = `Recommended retail price`, color = Line, shape = Brand)) +
  geom_point(size = 4) +
...
```{r}
device_data %>% 
  ggplot(aes(y = ReleasedYr, color = Line, fill = Line)) +
  geom_bar(stat="count") +
  scale_color_brewer(palette="Set3") +
...
# Batterty Lives
device_data %>% 
  ggplot(aes(y = `Battery life`, color = Line, fill = Line)) +
  geom_bar(stat="count") +
  scale_color_brewer(palette="Set3") +
  scale_fill_brewer(palette="Set3") +
...
# Waterproof
device_data %>% 
  ggplot(aes(y = `Water resitance`, color = Line, fill = Line)) +
  geom_bar(stat="count") +
  scale_color_brewer(palette="Set3") +
  scale_fill_brewer(palette="Set3") +
